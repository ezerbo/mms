...
public class SessionDAO extends DaoGenerique<Session> {
	...
	public Session create(Session session) {
		...
		try {
			...
			prepare.setInt(1, session.getUtilisateur().getIdutilisateur());
		...
		if (testeValue == 0)
			...
			return findUserLastSession(session.getUtilisateur()
					.getIdutilisateur());
	}
	public Session findUserLastSession(int idUtilisateur) {
