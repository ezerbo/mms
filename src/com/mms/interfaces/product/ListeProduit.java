package com.mms.interfaces.product;
...
import com.mms.interfaces.tablemodels.TableModelNouveauProduit;
...
public class ListeProduit extends JDialog implements ProduitListener {
	...
	public void abonne() {
		itemModifier.addActionListener(arg0 -> modifierProduit());
		itemSupprimer.addActionListener(arg0 -> JOptionPane.showMessageDialog(null
				, "Suppression !!!"
		...
		b_supprimer.addActionListener(e -> JOptionPane.showMessageDialog(null, "Suppression !!!"));
		b_fermer.addActionListener(e -> dispose());
		b_ajouter.addActionListener(e -> nouveauProduit.setVisible(true));
	...
	public static void main(String[] args) {
		// new ListeProduit().setVisible(true);i
	}
