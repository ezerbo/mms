		...
		switch (colonne) {
			...
			case 1 : {
				...
				if (!designation.equals("")) {
					Double totalHT = venteService.calculTotalHt(designation, Integer.parseInt(quantite));
					Double totalTva = venteService.calculMontantTva(totalHT);
					Double totalTtc = venteService.calculTotalTtc(totalHT, totalTva);
					...
					ligneDeVente.get(ligne).setTauxTva(parametres.getTauxtva() + "");
