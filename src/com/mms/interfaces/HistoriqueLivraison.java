...
import com.mms.tablemodels.TableModelBilanCredit;
import com.mms.tablemodels.TableModelHistoriqueVente;
import com.mms.tablemodels.TableModelHistoriqueOperation;
import com.mms.util.RechercheLivraison;

// Referenced classes of package interfaces:
//            Model, RechercheLivraison, BilanCreditTableModel, ModelListe
...
public class HistoriqueLivraison extends JDialog {
	...
	public void abonne() {
		...
		b_annulerVente.addActionListener(new ActionListener() {
