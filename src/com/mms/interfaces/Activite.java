...
import com.mms.tablemodels.TableModelActivites;
...
public class Activite extends JDialog {
	...
	public Activite(int idutilisateur) {
		setTitle("Activités de l'utilisateur");
		...
		tabbedPane.addTab("Ventes réalisées", panelSortie);
		tabbedPane.addTab("Livraisons enregistrées", panelEntree);
	...
	private void venteParametree(String designation) {
		...
		LinkedList<Lignedevente> ligneDeVente = venteService.statistiqueVente(dateDebut.getDate(),dateFin.getDate(),idUtilisateur);
	...
	private void abonne() {
		comboDesignation.addActionListener(new ActionListener() {
			@Override
	...
	public void afficherLivraison(String date) {
