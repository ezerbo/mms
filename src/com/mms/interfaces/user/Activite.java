...
import com.mms.interfaces.tablemodels.TableModelActivites;
...
public class Activite extends JDialog {
	...
	private void venteParametree(String designation) {
		...
		LinkedList<Lignedevente> ligneDeVente = venteService.statistiqueVente(dateDebut.getDate(), dateFin.getDate(),
	...
	private void abonne() {
		comboDesignation.addActionListener(arg0 -> {
			if (!comboDesignation.getSelectedItem().equals(labelTousLesProduits.getText())) {
				...
				LinkedList<Lignedevente> ligneDeVente = venteService.statistiqueVente(dateDebut.getDate()
