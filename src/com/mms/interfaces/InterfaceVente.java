...
public class InterfaceVente extends JPanel
		implements
			VenteListener,
			ClientListener,
			ProduitListener {
	...
	public InterfaceVente(String loginUtilisateur) {
	...
	private void abonnement() {
		...
		itemSupprimerLigneSelectionnee.addActionListener(new ActionListener() {
			@Override
			public void actionPerformed(ActionEvent arg0) {
				// TODO Auto-generated method stub
		...
		itemSupprimerToutesLesLignes.addActionListener(new ActionListener() {
			@Override
			public void actionPerformed(ActionEvent arg0) {
				// TODO Auto-generated method stub
		...
		venteComptant.addActionListener(new ActionListener() {
		...
		venteCredit.addActionListener(new ActionListener() {
		...
		b_enregistrer.addActionListener(new ActionListener() {// bouton
					// d'enregistrement
					// de la vente
		...
		b_apercuFacture.addActionListener(new ActionListener() {

			@Override
			public void actionPerformed(ActionEvent e) {
				// TODO Auto-generated method stub
				new InterfaceFacture(tableModel.getLigneDeVente());
			}
		});
		...
		if (!nom_prenom.equals("")) {
			for (int i = 0; i < nom_prenom.length(); i++) {
				if (nom_prenom.charAt(i) == ' ') {
					client.setNomClient(nom_prenom.substring(0, i));client.setPrenomClient(nom_prenom.substring(i + 1,nom_prenom.length()));
					break;
				}
			}
		} else {
	...
	/*** methode execut�e lorque l'envenement ClientEvent survient ***/
	@Override
	public void ajouterClient(ClientEvent event) {
		// TODO Auto-generated method stub
		afficheListeClient();
	}
	/*** methode execut�e lorque l'envenement Produit survient ***/
	@Override
